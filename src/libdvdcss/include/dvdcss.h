...
#define DVDCSS_VERSION_CODE(major, minor, micro) (((major) * 10000) + ((minor) * 100) + (micro))
#define DVDCSS_VERSION DVDCSS_VERSION_CODE(DVDCSS_VERSION_MAJOR, DVDCSS_VERSION_MINOR, DVDCSS_VERSION_MICRO)
